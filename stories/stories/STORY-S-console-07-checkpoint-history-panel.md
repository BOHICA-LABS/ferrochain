...
### AC-001 (traces to BC-2.24.005 PC-001)
...
### AC-002 (traces to BC-2.24.005 PC-002; traces to BC-2.12.001 PC-015)
...
### AC-003 (traces to BC-2.24.005 PC-003)
...
### AC-004 (traces to BC-2.24.005 PC-004)
...
### AC-005 (traces to BC-2.24.005 INV-001)
...
### AC-006 (traces to BC-2.24.005 EC-001)
...
### AC-007 (traces to BC-2.24.005 EC-002; traces to BC-2.12.001 EC-010)
...
| No new server endpoints introduced | BC-2.24.005 PC-005 | Code review: only calls existing endpoints |
